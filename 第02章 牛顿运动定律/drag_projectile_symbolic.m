...
t=0:0.01:4;                            %时间向量
%------------------------------------------------------------
[sx,sy]=dsolve('D2x+Dx,D2y-1+Dy,Dx(0)=v0,Dy(0)=0,x(0)=0,y(0)=0')%求微分方程的符号解
x=subs(sx,'v0',v0);                    %替换初速度
x=subs(x,'t',t);                       %替换时间形成横坐标
y=subs(sy,'v0',v0);                    %替换初速度
y=subs(y,'t',t);                       %替换时间形成纵坐标
%------------------------------------------------------------
xx=v0*t;                               %无阻力的横坐标
yy=t.^2/2;                             %无阻力的横坐标
figure                                 %开创图形窗口
